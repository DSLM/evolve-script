...
// @match        https://likexia.gitee.io/evolve/''',
    ...
    'addWeightingRule(tableBodyNode, "Not housing, barrack, or knowledge building", "MAD prestige enabled, and affordable", "buildingWeightingMADUseless");':'addWeightingRule(tableBodyNode, "提升人口、士兵或知识上限以外的建筑", "进行核爆重置，且已研究相互毁灭", "buildingWeightingMADUseless");',
